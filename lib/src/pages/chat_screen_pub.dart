...
import 'package:ff_chat/src/services/presence_service_pub.dart';
...
class ChatScreenPub extends StatefulWidget {
  const ChatScreenPub({
    super.key,
  ...
  @override
  State<ChatScreenPub> createState() => _ChatScreenPubState();
}

class _ChatScreenPubState extends State<ChatScreenPub> {
  final _messageController = TextEditingController();
  final _scrollController = ScrollController();
  final _focusNode = FocusNode();

  late final _chatService;
  ...
  void initState() {
    ...
    _chatService = ChatService(currentUserId: widget.currentUserId);
    ...
    _presenceService = PresenceServicePub(userId: widget.currentUserId);
  ...
  Widget _buildMessageList() {
    return StreamBuilder<List<ChatMessage>>(
      stream: _chatService.getMessages(widget.currentUserId, widget.receiverId),
      builder: (context, snapshot) {
        ...
        for (final msg in messages) {
          if (!msg.readBy.contains(widget.currentUserId)) {
